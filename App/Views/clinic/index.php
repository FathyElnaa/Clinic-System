    ...
    <div class="d-flex flex-wrap gap-4 justify-content-center">
        <?php foreach ($majors as $major): ?>
            <div class="card p-2" style="width: 18rem;">
                ...
                <img src="uploads/<?= $major->getImage() ?>" class="card-img-top rounded-circle card-image-circle"
                    alt="major">
                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                    <h4 class="card-title fw-bold text-center"><?= $major->getNameM() ?></h4>
                    <a href="index.php?page=Doctors-index&id=<?=$major->getID() ?>" class="btn btn-outline-primary card-button">Browse Doctors</a>
                </div>
            </div>
        <?php endforeach ?>
    </div>
