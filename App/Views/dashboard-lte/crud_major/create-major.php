		...
		<div class="content-wrapper">
				...
				<div class="container-fluid my-2">
					<div class="row mb-2">
						...
						<div class="col-sm-6 text-right">
							<a href="dashboard.php?page=majors" class="btn btn-primary">Back to Majors</a>
						</div>
					</div>
				</div>
				<!-- /.container-fluid -->
			...
			<section class="content">
				...
				<div class="container-fluid">
					<form action="dashboard.php?page=Control-Major&action=major-store" method="post" enctype="multipart/form-data">
						<div class="card">
							<div class="card-body">
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="name" id="name" class="form-control" placeholder="Major Name">
										</div>
									</div>
									...
									<div class="col-md-12">
										<div class="mb-3">
											...
											<textarea name="description" id="description" class="form-control" rows="3" placeholder="Brief description of the specialty"></textarea>
										</div>
									</div>
								</div>
							</div>
